...
#region Basis CustomTheme Elemente

internal class CustomThemeDark : Control
{
...
internal class CustomButton_Bright : Control
{
...
internal class CustomButton_Dark : Control
{
    private readonly Brush B1;
    private readonly Brush B2;
    private readonly Brush B5;
...
internal class CustomProgressBarBright : Control
{
    #region  Properties
    ...
    public CustomProgressBarBright()
    {
...
internal class CustomSeperatorBright : Control
{
    private readonly Color C1;
    private readonly Pen P1;
    private readonly Pen P2;
...
internal class CustomSeperatorDark : Control
{
    private readonly Color C1;
    private readonly Pen P1;
    private readonly Pen P2;
...
#region CustomButtonColor Elemente (Rot, Grün, Blau, Orange, Schwarz, Weiss, Braun, Lila, Pink, Gelb, Dunkelrot, Dunkelgrün, Dunkelblau)

internal class CustomButtonGreen : ThemeControl
{
...
internal class CustomButtonBlue : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonRed : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonOrange : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonBlack : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonWhite : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonBrown : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonPurple : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonPink : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonYellow : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonDarkRed : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonDarkGreen : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal class CustomButtonDarkBlue : ThemeControl
{
    public override void PaintHook()
    {
        Font = new Font("Arial", 10);
...
internal abstract class CustomLightContainer : ContainerControl
{
    #region " Initialization "
...
internal class CustomLightGrpPnlBox : ThemeContainerControl
{
    public CustomLightGrpPnlBox()
    {
        AllowTransparent();
    }
...
internal class CustomLightPanelBox : ThemeContainerControl
{
    public CustomLightPanelBox()
    {
        AllowTransparent();
    }
...
internal class CustomLightGrpDrpDwn : ThemeContainerControl
{
    private int X;
    private bool _Checked;
    ...
    public CustomLightGrpDrpDwn()
    {
        AllowTransparent();
        Size = new Size(90, 30);
        MinimumSize = new Size(5, 30);
        _Checked = true;
        Resize += CustomLightGrpDrpDwn_Resize;
        MouseDown += CustomLightGrpDrpDwn_MouseDown;
    }
    ...
    private void CustomLightGrpDrpDwn_Resize(object sender, EventArgs e)
    {
        if (_Checked)
        {
            _OpenedSize = Size;
    ...
    private void CustomLightGrpDrpDwn_MouseDown(object sender, MouseEventArgs e)
    {
        if (X >= Width - 22)
        {
            if (y <= 30)
...
internal class CustomLightGrpPanelBox : ThemeContainerControl
{
    public CustomLightGrpPanelBox()
    {
        AllowTransparent();
    }
...
internal abstract class CustomDarkContainer : ContainerControl
{
    #region " Initialization "
...
internal class CustomDarkGrpDrpDwn : ThemeContainerControl
{
    private int X;
    private bool _Checked;
    private Size _OpenedSize;
    ...
    public CustomDarkGrpDrpDwn()
    {
        AllowTransparent();
        Size = new Size(90, 30);
        MinimumSize = new Size(5, 30);
        _Checked = true;
        Resize += CustomDarkGrpDrpDwn_Resize;
        MouseDown += CustomDarkGrpDrpDwn_MouseDown;
    }
    ...
    private void CustomDarkGrpDrpDwn_Resize(object sender, EventArgs e)
    {
        if (_Checked)
        {
            _OpenedSize = Size;
    ...
    private void CustomDarkGrpDrpDwn_MouseDown(object sender, MouseEventArgs e)
    {
        if (X >= Width - 22)
        {
            if (y <= 30)
...
internal class CustomDarkGrpPnlBox : ThemeContainerControl
{
    public CustomDarkGrpPnlBox()
    {
        AllowTransparent();
    }
...
public class ExtendedGraphics
{
        ...
        float radius)
    {
        ...
        float diaCustomr = radius * 2.0F;
        var sizeF = new SizeF(diaCustomr, diaCustomr);
        ...
        // top right arc 
        arc.X = baseRect.Right - diaCustomr;
        path.AddArc(arc, 270, 90);

        // bottom right arc 
        arc.Y = baseRect.Bottom - diaCustomr;
...
internal class FreshTheme : ThemeContainer154
{
    // Fields
...
internal class FreshThemeX : ThemeContainer154
{
    // Fields
    private Color Accent;
    private Color Border;
...
internal class FreshThemeBlue : ThemeContainer154
{
    // Fields
    private Color Accent;
    private Color Border;
...
internal class FreshThemeGreen : ThemeContainer154
{
    // Fields
    private Color Accent;
    private Color Border;
...
internal class FreshThemeWhite : ThemeContainer154
{
    // Fields
    private Color Accent;
    private Color Border;
...
internal class FreshButton : ThemeControl154
{
    // Fields
    private Color G1;
    private Color G2;
...
internal class FreshComboBox : ComboBox
{
    // Fields
    private GraphicsPath CreateRoundPath;
    private Rectangle CreateRoundRectangle;
...
internal class FreshControlBox_TwoButtons : ThemeControl154
{
    // Fields
    private Color G1;
    private Color G2;
    ...
    // Methods
    public FreshControlBox_TwoButtons()
    {
...
internal class FreshListbox : ListBox
{
    // Fields
...
internal class FreshProgressBar : ThemeControl154
{
    // Fields
    private Color Edge;
    private Color G1;
...
internal class FreshSeparator : ThemeControl154
{
    // Fields
    private Color Accent;
    private Color Border;
...
internal class FreshTabcontrol : TabControl
{
    // Fields
    private readonly Pen Border;

    // Methods
    public FreshTabcontrol()
    {
        Border = Pens.Black;
        SetStyle(
            ControlStyles.DoubleBuffer | ControlStyles.AllPaintingInWmPaint | ControlStyles.ResizeRedraw |
...
internal class FreshTabcontrolX : TabControl
{
    // Fields
    private readonly Pen Border;

    // Methods
    public FreshTabcontrolX()
    {
        Border = Pens.Black;
        SetStyle(
            ControlStyles.DoubleBuffer | ControlStyles.AllPaintingInWmPaint | ControlStyles.ResizeRedraw |
...
[DefaultEvent("TextChanged")]
internal class FreshTextBox : ThemeControl154
{
    // Fields
